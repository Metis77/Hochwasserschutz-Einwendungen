...
- **Anlage D 3.0** - saP (Artenschutz)
- **Anlage D 6.0** - Biotopkartierung
- **Anlage H 2** - Grundstücksverzeichnis

## Betroffenheit Wöhrdstraße 41

**Flurstück 1791:** 5.573 m² Grundstücksgröße

| Eingriff                | Details                     |
| ----------------------- | --------------------------- |
| Temporäre Beanspruchung | 1.941 m² (35%)              |
| Baumfällungen           | Im Obstgarten               |
| Technikgebäude          | Mit Trafoanlage             |
| Grunddienstbarkeit      | Dauerhaftes Betretungsrecht |
...
| Geschätzte Kosten | 50-55 Mio. Euro                     |
| Lage              | UNESCO-Welterbe Pufferzone          |

---

_Stand: 11. Januar 2026_
